  ...
  return (
    <div className="flex h-full flex-col px-3 py-4 md:px-2">
      ...
      <div className="flex grow flex-row justify-between space-x-2 md:flex-col md:space-x-0 md:space-y-2">
        ...
        {/* <form>
          <button className="w-full flex h-[48px] grow items-center justify-center gap-2 rounded-md bg-gray-50 dark:bg-slate-800 dark:text-slate-50 p-3 text-sm font-medium hover:bg-sky-100 hover:text-blue-600 dark:hover:bg-sky-100 dark:hover:text-blue-600 md:flex-none md:justify-start md:p-2 md:px-3">
            <PowerIcon className="w-6" />
